...
app = FastAPI(title="Worker Agent 1")

def process_logic(state: dict):
    """Specific logic for agent_1 node."""
    print("Entered agent_1 process_logic with state:", state)
    last_msg = state['messages'][-1]['content']
    prompt = f"System: You are Agent 1. Processing: {last_msg}"
